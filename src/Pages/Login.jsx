        ...
        <div className='w-full max-w-md p-8 space-y-4 bg-white shadow-lg rounded-xl'>
          ...
          <form action="" className='space-y-6'>
            ...
            <div className='relative'>
              ...
              border-gray-300 rounded-lg focus:ring focus:ring-red-300 focus:outline-none'
                 required
                />
            ...
            {/* submit button */}
            <button type='submit' className='w-full px-4 py-2 text-white bg-red-500 rounded-lg hover:bg-red-600
            focus:outline-none focus:ring focus:ring-red-300'>Login</button>
          </form>
